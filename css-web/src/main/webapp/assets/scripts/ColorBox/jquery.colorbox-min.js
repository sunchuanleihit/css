...
(function (t, e, i) {
    ...
    function g() {
        z = 0,
        rel && "nofollow" !== rel ? (E = t("." + te).filter(function () {
            var e = t.data(this, Y),
            i = new r(this, e);
    ...
    function f(i) {
        ...
        if (!G) {
            ...
            v.css({
                opacity: parseFloat(_.get("opacity")) || "0",
    ...
    function m() {
        ...
        function (t) {
            ...
            $ && _.get("arrowKey") && E[1] && !t.altKey && (37 === e ? (t.preventDefault(), P.click()) : 39 === e && (t.preventDefault(), K.click()))
    ...
    function w() {
        ...
        100),
        _.get("inline") ? (h = n(se).hide().insertBefore(t(o)[0]), ae.one(he,
        function () {
            h.replaceWith(L.children())
        }), d(t(o))) : _.get("iframe") ? d(" ") : _.get("html") ? d(_.get("html")) : s(_, o) ? (o = l(_, o), U = e.createElement("img"), t(U).addClass(Z + "Photo").bind("error",
        function () {
            d(n(se, "Error").html(_.get("imgError")))
        }).one("load",
        function () {
            var e;
            c === le && (t.each(["alt", "longdesc", "aria-describedby"],
            function (e, i) {
    ...
    ce = function () {
        ...
        function i() {
            I.html(_.get("slideshowStop")).unbind(s).one(s, n),
        ...
        function n() {
            ...
            I.html(_.get("slideshowStart")).unbind(s).one(s,
            function () {
                J.next(),
                i()
            }),
    ...
    J.prep = function (i) {
        ...
        if ($) {
            ...
            d = function () {
                ...
                R.html(_.get("title")).show(), L.show(), a > 1 ? ("string" == typeof _.get("current") && F.html(_.get("current").replace("{current}", z + 1).replace("{total}", a)).show(), K[_.get("loop") || a - 1 > z ? "show" : "hide"]().html(_.get("next")), P[_.get("loop") || z ? "show" : "hide"]().html(_.get("previous")), ce(), _.get("preloading") && t.each([h(-1), h(1)],
                function () {
                    var i, n = E[this],
    ...
    J.close = function (rv) {
        _.cache.returnValue = rv;
        $ && !G && (G = !0, $ = !1, u(oe), _.get("onCleanup"), W.unbind("." + Z), v.fadeTo(_.get("fadeOut") || 0, 0), x.stop().fadeTo(_.get("fadeOut") || 0, 0,
        function () {
            x.hide(),
            v.hide(),
            u(he),
