...
(function($) {
	...
	function _43d(_43e) {
		...
		}).bind("mouseover.datagrid",
		function() {
			var _900 = $(this).parent().attr("datagrid-row-index");
			var _901 = $(this).attr("field");
			var _902 = data.rows[_900][_901];
			opts.onMouseoverCell.call(_43e, _900, _901, _902,this);
		}).bind("mouseout.datagrid",
		function() {
			var _903 = $(this).parent().attr("datagrid-row-index");
			var _904 = $(this).attr("field");
			var _905 = data.rows[_903][_904];
			opts.onMouseoutCell.call(_43e, _903, _904, _905,this);
		});
	...
	$.fn.panel.defaults, {
		...
		onMouseoverCell:function(_5ac,_5ad,_5ae){},
		onMouseoutCell:function(_5af,_5ba,_5bb,_5bc){},
		onDblClickCell: function(_598, _599, _59a,_5bd) {},
