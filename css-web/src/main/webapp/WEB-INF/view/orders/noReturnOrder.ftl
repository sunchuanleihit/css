			...
			<div title="订单列表" closable="true" style="padding:20px;">  
				<div id="panel" style="padding:20px;border:1px solid #dadada;">
					<form id="no_return_search_form">
						...
						<span class="inputspan">用户名</td><td><input type="text" id="buyerName"/></span>
						<span class="inputspan">单据日期</td><td><input type="text" id="startTime"/>--</td><td><input type="text" id="endTime"/></span>
